...
interface EgyptFlagProps extends React.SVGProps<SVGSVGElement> {
  className?: string;
  width?: number | string;
...
export function EgyptFlag({
  className = "w-5 h-3.5 rounded-[2px] inline-block shrink-0 overflow-hidden shadow-sm border border-white/10",
  width,
  height,
  ...props
}: EgyptFlagProps) {
  return (
    <svg
      ...
      {...props}
    >
      <rect width="640" height="480" fill="#000001" />
      <rect width="640" height="320" fill="#ffffff" />
      <rect width="640" height="160" fill="#ce1126" />
      <g fill="#ffffff" stroke="#c09300" transform="translate(-40) scale(.8)">
        <path
        ...
        />
        <use href="#eg-flag-feather" width="100%" height="100%" transform="matrix(-1 0 0 1 900 0)" />
        <path
          fill="#c09300"
          strokeWidth="1.1"
          d="m453.2 315 9.6 43.8-3.2 3.2-3.3-2.5-5.4-39 2.3 39-3.2 4-3.1-4 2.3-39-5.5 39-3.3 2.5-3.2-3.2 9.6-43.7h6.4z"
        />
        <g id="eg-flag-wing" fill="none" strokeLinejoin="round" strokeWidth="1.3">
          <path fill="#ffffff" strokeWidth="1.2" d="m428.5 295.8-19.1 67.7 26.3 4 11.1-50.9z" />
        ...
        <use href="#eg-flag-wing" width="100%" height="100%" transform="matrix(-1 0 0 1 900 0)" />
