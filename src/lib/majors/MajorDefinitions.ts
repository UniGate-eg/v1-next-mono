...
export const MAJOR_DEFINITIONS: MajorDefinition[] = [
...

  {
    ...
    name_ar: "الهندسة المدنية والتشييد",
    icon: "🏗️",
    color: "#f59e0b",
    keywords: [
      "civil engineering",
  ...
  {
    id: "languages",
    name: "Languages, Translation & Al-Alsun",
    name_ar: "اللغات والترجمة والألسن",
    icon: "🗣️",
    color: "#6366f1",
    keywords: [
      "languages",
...

  {
    ...
    name_ar: "العلوم الصحية التطبيقية",
    icon: "🔬",
    color: "#06b6d4",
    keywords: [
...

  {
    ...
    name_ar: "السياحة وإدارة الفنادق",
    icon: "🏨",
    color: "#8b5cf6",
    keywords: [
      "tourism",
  ...
  {
    id: "electrical-eng",
    name: "Electrical & Communications Engineering",
    name_ar: "الهندسة الكهربائية والاتصالات",
    icon: "⚡",
    color: "#3b82f6",
    keywords: [
...

  {
    ...
    name_ar: "العلوم الإنسانية والاجتماعية",
    icon: "🏛️",
    color: "#ec4899",
    keywords: [
      "humanities",
...

  {
    ...
    name_ar: "العلوم الطبيعية والرياضيات",
    icon: "🔬",
    color: "#2dd4bf",
    keywords: [
      "natural sciences",
